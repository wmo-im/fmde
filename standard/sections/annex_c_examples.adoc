...
Each example below is a complete `FirstMileMessage`, with the `metadata` or `data` oneof field populated as appropriate.
...
[source,json]
----
include::../../examples/hydrostation/metadata.json[]
----

.FirstMileMessage (data)
[source,json]
----
include::../../examples/hydrostation/data.json[]
----
...
[source,json]
----
include::../../examples/meteostation/metadata.json[]
----

.FirstMileMessage (data)
[source,json]
----
include::../../examples/meteostation/data.json[]
----
