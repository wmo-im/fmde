...
NOTE: qThis specification will be further expanded (2027) to also address the encoding and the transmission of configuration aspects from the central data collection system (Hub) to the remote monitoring stations (Nodes).
